...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Omprakash_Choudhari\PycharmProjects\Nifty_Automation_Framework\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Omprakash_Choudhari\PycharmProjects\Nifty_Automation_Framework\venv\Scripts\deactivate.nu'
